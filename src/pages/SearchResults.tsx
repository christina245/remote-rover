      ...
      {selectedLocation && (
        ...
        >
          <LocationDetailsPanel
            location={{
              ...selectedLocation,
              address: selectedLocation.formatted_address || selectedLocation.address,
              ...
              googleMapsUrl: `https://www.google.com/maps/place/${encodeURIComponent(selectedLocation.name + ' ' + (selectedLocation.formatted_address || selectedLocation.address || ''))}`,
